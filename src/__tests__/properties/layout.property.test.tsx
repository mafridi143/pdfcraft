...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} ZemPDF. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "ZemPDF" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays ZemPDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('ZemPDF');
    ...
    it('Footer component displays ZemPDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('ZemPDF');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('ZemPDF-language-preference', invalidLocale);
