...
export class CertCryptorProcessor extends BasePDFProcessor {
  async process(
    ...
    try {
      ...
      // Draw Central Stamp Symbol (e.g. Shield + Key / ZemPDF Logo)
      ...
      const signatureDict = context.obj({
        ...
        Reason: pdfLib.PDFString.of('Signed officially using ZemPDF Wax-Seal cryptor.'),
      ...
      if (certFile || cryptorOptions.encryptWithCert) {
        ...
        const userPassword = cryptorOptions.pfxPassword || 'zempdf';
