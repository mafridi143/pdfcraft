...
export const toolContentEn: Record<string, ToolContent> = {
  ...
  'cert-cryptor': {
    ...
    faq: [
      ...
      { question: 'Can I customize the stamp design?', answer: 'Yes. We provide multiple designs like the ZemPDF watermark or a Royal crest, and you can adjust the wax melting radius and normal-map indentation depth in the panel.' },
    ],
  },
